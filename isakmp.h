...
/* AEAD ciphers (RFC 4309, RFC 5282): no INTEG transform in same proposal */
#define IKEV2_ENCR_AES_CCM_8		14	/* RFC 4309 - 8-byte ICV */
#define IKEV2_ENCR_AES_CCM_12		15	/* RFC 4309 - 12-byte ICV */
#define IKEV2_ENCR_AES_CCM_16		16	/* RFC 4309 - 16-byte ICV */
#define IKEV2_ENCR_AES_GCM_8		18	/* RFC 5282 - 8-byte ICV */
#define IKEV2_ENCR_AES_GCM_12		19	/* RFC 5282 - 12-byte ICV */
#define IKEV2_ENCR_AES_GCM_16		20	/* RFC 5282 - 16-byte ICV (most common) */
#define IKEV2_ENCR_NULL_AUTH_AES_GMAC	21	/* RFC 4543 */
#define IKEV2_ENCR_CAMELLIA_CBC		23	/* RFC 5529 */
#define IKEV2_ENCR_CAMELLIA_CTR		24	/* RFC 5529 */
#define IKEV2_ENCR_CAMELLIA_CCM_8	25	/* RFC 5529 */
#define IKEV2_ENCR_CAMELLIA_CCM_12	26	/* RFC 5529 */
#define IKEV2_ENCR_CAMELLIA_CCM_16	27	/* RFC 5529 */
#define IKEV2_ENCR_CHACHA20_POLY1305	28	/* RFC 7634 - AEAD, fixed 256-bit key */
...
#define IKEV2_PRF_AES128_CMAC		8	/* RFC 4615 */
...
#define IKEV2_AUTH_HMAC_MD5_128		6
#define IKEV2_AUTH_HMAC_SHA1_160	7
#define IKEV2_AUTH_AES_CMAC_96		8	/* RFC 4494 */
#define IKEV2_AUTH_AES_128_GMAC		9	/* RFC 4543 */
#define IKEV2_AUTH_AES_192_GMAC		10	/* RFC 4543 */
#define IKEV2_AUTH_AES_256_GMAC		11	/* RFC 4543 */
...
/* IKEv2 Diffie-Hellman group numbers (IANA IKEv2 Transform Type 4) */
#define IKEV2_DH_MODP_768		1	/* RFC 2409 - weak */
#define IKEV2_DH_MODP_1024		2	/* RFC 2409 - weak */
#define IKEV2_DH_MODP_1536		5	/* RFC 3526 */
#define IKEV2_DH_MODP_2048		14	/* RFC 3526 - minimum recommended */
#define IKEV2_DH_MODP_3072		15	/* RFC 3526 */
#define IKEV2_DH_MODP_4096		16	/* RFC 3526 */
#define IKEV2_DH_MODP_6144		17	/* RFC 3526 */
#define IKEV2_DH_MODP_8192		18	/* RFC 3526 */
#define IKEV2_DH_ECP_256		19	/* RFC 5903 - most common ECP group */
#define IKEV2_DH_ECP_384		20	/* RFC 5903 */
#define IKEV2_DH_ECP_521		21	/* RFC 5903 */
#define IKEV2_DH_MODP_1024_160		22	/* RFC 5114 */
#define IKEV2_DH_MODP_2048_224		23	/* RFC 5114 */
#define IKEV2_DH_MODP_2048_256		24	/* RFC 5114 */
#define IKEV2_DH_BRAINPOOL_P256		28	/* RFC 6954 */
#define IKEV2_DH_BRAINPOOL_P384		29	/* RFC 6954 */
#define IKEV2_DH_BRAINPOOL_P512		30	/* RFC 6954 */
#define IKEV2_DH_CURVE25519		31	/* RFC 8031 */
#define IKEV2_DH_CURVE448		32	/* RFC 8031 */
